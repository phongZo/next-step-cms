...
const apiConfig = {
    ...
    candidate: {
        ...
        changeStatus: {
            baseURL: `${apiUrl}v1/candidate/change-status`,
            method: 'PUT',
            headers: baseHeader,
            permissionCode: 'CAN_U_STATUS',
        },
    },
    company: {
        getList: {
